    ...
    <footer ref={containerRef} id="contacts" className="bg-[#050505] text-white pt-16 md:pt-24 px-6 md:px-12 border-t border-white/5 relative overflow-hidden flex flex-col min-h-[50vh]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 mb-8 lg:mb-12 z-10 relative">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="font-semibold text-lg tracking-tight">Swensi.Dev ™</div>
        ...
        <div className="lg:col-span-7 grid grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col gap-5">
            ...
            <a href="https://t.me/swensi17" target="_blank" rel="noreferrer" className="text-neutral-400 hover:text-white transition-colors text-sm">Написать мне</a>
